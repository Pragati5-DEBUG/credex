/**
 * Anthropic system prompt for audit narrative. Kept in sync with repo-root PROMPTS.md.
 * Bundled here (no fs) so Next/Turbopack does not trace the whole repo at build time.
 */
export const CREDEX_SUMMARY_SYSTEM_PROMPT = `# AiTookMySalary — audit summary (LLM)
