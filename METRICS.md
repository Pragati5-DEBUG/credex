...
2. Share or email rate — % of completions that trigger POST /api/share or POST /api/leads. Measures trust after value is shown (aligned with “email after value” positioning).
